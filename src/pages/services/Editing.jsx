...
const Chooseus = [
  {
    ...
    text: "We review your manuscript for structure, pacing, grammar, tone, and overall readability before editing begins.",
    
  },
  {
    number:"02",
    title: "Developmental Editing",
    text: "Our editors improve clarity, consistency, flow, and storytelling while strengthening your message and narrative.",
  },
  {
    number:"03",
    title: "Copyediting & Proofreading",
    text: "We correct grammar, punctuation, spelling, and formatting errors to ensure a clean, professional manuscript.",
  },
  {
    number:"04",
    title: "Final Quality Check",
    text: "A final review ensures your manuscript is polished, publication-ready, and free from overlooked issues.",  
  },
...
export default function Editing() {
  ...
  <div>
    <SEO
        title="Editing & Proofreading Services | Seawings Publications" 
        description="Professional editing and proofreading services to refine your manuscript with clarity, structure, and accuracy for a polished, publish-ready book."
        keyword="editing and proofreading services"
        link="https://www.seawingspublications.com/editing-&-proofreading"
    ...
    <section className="relative w-full min-h-[900px] bg-black z-10 flex flex-col items-center justify-center">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-[200px] md:pt-[110px] pb-[50px] relative z-20">
        ...
        >
          ...
          >
            Every story deserves to shine. Our editors precisely refine your manuscript, polishing language, structure, and flow while keeping your authentic voice intact.
          </motion.p>
            {/* Animated List Items */}
    ...
    <section className="relative w-full bg-white overflow-hidden z-0">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row gap-16 items-center justify-between px-4 md:px-8 py-16 relative">
        ...
        >
          ...
          >
            Polishing Every Page to Perfection
          </motion.h2>
          ...
          >
            Editing is more than correction; it’s a transformation. At Seawings Publications, we provide comprehensive editing and proofreading services designed to elevate your manuscript to a professional, publish-ready standard.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            Our editorial process includes structural editing, line editing, and final proofreading to ensure clarity, coherence, and consistency. We look at everything from sentence rhythm and word choice to formatting and presentation, creating a smooth reading experience that resonates with your audience.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            With a balance of creativity and technical accuracy, our expert editors polish your words without changing them. Whether it’s a novel, memoir, or non-fiction title, Seawings ensures your book reflects your intent and excellence.
          </motion.p>
            ...
            >
              ...
              {Chooseus.map((Chooseus, index) => (
                <div className="relative w-[350px] md:w-[300px] rounded-[32px] bg-white px-6 pt-12 pb-4 shadow-xl flex flex-col justify-center items-center md:items-start">
                  ...
                  <h3 className="text-[28px] font-semibold leading-tight text-[#171717] text-left mt-2">{Chooseus.title}</h3>
