...
const Chooseus = [
  {
    ...
    text: "We review your manuscript for audiobook-specific formatting, chapter flow, and pronunciation guides before production begins.",
    
  },
  {
    number:"02",
    title: "Voice Casting",
    text: "We match your book's tone, genre, and audience with the ideal narrator — from warm storytelling voices to dramatic character-driven reads.",
  },
  {
    number:"03",
    title: "Studio Recording",
    text: "Professional studio recording with noise-free environments, broadcast-grade microphones, and experienced audio engineers throughout.",
  },
  {
    number:"04",
    title: "Mastering & Delivery",
    text: "Audio is mastered to platform specifications and delivered ready for Audible, ACX, Findaway Voices, and all major audiobook retailers.",  
  },
...
export default function AudioBook() {
  ...
  <div>
    <SEO
        title="Audiobook Publishing Services | Seawings Publications" 
        description="Professional audiobook publishing services including narration, production, editing, and distribution to reach listeners worldwide."
        keyword="audiobook publishing services"
        link="https://seawingspublications.com/audiobook"
    ...
    <section className="relative w-full min-h-[900px] bg-black z-10 flex flex-col items-center justify-center">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-[200px] md:pt-[110px] pb-[50px] relative z-20">
        ...
        >
          ...
          >
Bring your words to life through sound. Seawings Publications delivers studio-quality audiobooks that captivate listeners and expand your book's reach to every ear worldwide.          </motion.p>
            {/* Animated List Items */}
    ...
    <section className="relative w-full bg-white overflow-hidden z-0">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row gap-16 items-center justify-between px-4 md:px-8 py-16 relative">
        ...
        >
          ...
          >
            At Seawings Publications, we transform your manuscript into a professionally produced audiobook. Our experienced narrators and sound engineers work together to ensure every word lands with clarity, emotion, and impact.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            We manage everything from casting the perfect voice talent to mastering the final audio files — delivering a product that meets ACX, Findaway, and major platform standards for worldwide distribution.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            Whether your genre is fiction, non-fiction, self-help, or children's literature, we tailor the narration style and pacing to match your audience and your story's unique tone.
          </motion.p>
            ...
            >
              ...
              {Chooseus.map((Chooseus, index) => (
                <div className="relative w-[350px] md:w-[300px] rounded-[32px] bg-white px-6 pt-12 pb-4 shadow-xl flex flex-col justify-center items-center md:items-start">
                  ...
                  <h2 className="absolute top-2 right-2 gradient-text text-[42px] text-white font-medium opacity-25">
                    {Chooseus.number}
                  </h2>
                  <h3 className="text-[24px] font-semibold leading-tight text-[#171717] text-left mt-2">{Chooseus.title}</h3>
