...
const Chooseus = [
  {
    number:"01",
    title: "Brand & Audience Strategy",
    text: "We identify your target audience and create a tailored marketing strategy for maximum visibility and engagement.",
    
  },
  {
    number:"02",
    title: "Promotional Content Creation",
    text: "Our team develops press materials, social media creatives, ad copy, and branded promotional assets.",
  },
  {
    number:"03",
    title: "Campaign Launch & Outreach",
    text: "We promote your book through media outreach, influencer engagement, advertising, and online campaigns.",
  },
  {
    number:"04",
    title: "Performance & Growth Tracking",
    text: "Campaign results are monitored and optimized to improve reach, audience engagement, and book sales over time.",  
  },
...
export default function Marketing() {
  ...
  <div>
    <SEO
        title="Book Marketing & PR Campaigns Services | Seawings Publications" 
        description="Boost your book with expert marketing, PR campaigns, social media, and promotions to reach readers and increase visibility worldwide."
        keyword="Book Marketing & PR Campaigns Services"
        link="https://www.seawingspublications.com/marketing-&-campaigns"
    ...
    <section className="relative w-full min-h-[900px] bg-black z-10 flex flex-col items-center justify-center">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-[200px] md:pt-[110px] pb-[50px] relative z-20">
        ...
        >
          ...
          >
            Publishing is just the beginning; now it’s time to be seen. Our marketing experts help your book find its audience and make a lasting impression.
          </motion.p>
            {/* Animated List Items */}
    ...
    <section className="relative w-full bg-white overflow-hidden z-0">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row gap-16 items-center justify-between px-4 md:px-8 py-16 relative">
        ...
        {/* Left Side Image */}
        <motion.div 
          className='md:w-1/2 z-20 flex justify-center md:justify-start'
        ...
        >
          ...
          >
            Get Your Book Seen, Shared, and Sold
          </motion.h2>
          ...
          >
            A great book deserves excellent visibility. Seawings Publications offers tailored marketing and public relations services designed to boost your presence and build long-term readership with your readers.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            Our strategies include social media campaigns, press releases, author branding, email marketing, and online book promotions, all customized to your genre and goals. We focus on building real engagement, ensuring your book connects with the readers most likely to love it.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            From pre-launch buzz to ongoing PR outreach, our team combines creativity with analytics to deliver results that matter. With Seawings, your story doesn’t just reach shelves, it reaches hearts.
          </motion.p>
