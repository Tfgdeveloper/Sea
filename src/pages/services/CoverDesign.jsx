...
const Chooseus = [
  {
    ...
    text: "We explore your book’s theme, audience, and genre to develop a strong visual direction for the design.",
    
  },
  {
    number:"02",
    title: "Custom Artwork Creation",
    text: "Our designers create professional covers and illustrations that capture the essence of your story.",
  },
  {
    number:"03",
    title: "Design Refinement & Feedback",
    text: "You review the concepts and collaborate with our team to refine colors, typography, and artwork details.",
  },
  {
    number:"04",
    title: "Final Production Files",
    text: "We deliver high-resolution print and digital-ready files optimized for publishing platforms and marketing use.",  
  },
...
export default function CoverDesign() {
  ...
  <div>
    <SEO
        title="Book Cover Design & Illustrations | Seawings Publications" 
        description="Get professional book cover design and custom illustrations tailored to your genre, style, and audience to make your book visually stand out."
        keyword="book cover design and illustrations Service"
        link="https://www.seawingspublications.com/coverdesign-&-Illustrations"
    ...
    <section className="relative w-full min-h-[900px] bg-black z-10 flex flex-col items-center justify-center">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row items-center justify-between px-4 md:px-8 pt-[200px] md:pt-[110px] pb-[50px] relative z-20">
        ...
        >
          ...
          >
            Cover Design & Illustration Service
          </motion.h1>
          ...
          >
Your book’s first impression should capture hearts. Our creative team designs covers and illustrations that reflect your story’s soul and attract readers immediately.          </motion.p>
            {/* Animated List Items */}
    ...
    <section className="relative w-full bg-white overflow-hidden z-0">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row gap-16 items-center justify-between px-4 md:px-8 py-16 relative">
        ...
        >
          ...
          >
            Designs That Speak Before Words Do
          </motion.h2>
          ...
          >
            A book cover is more than artwork; it’s your story’s identity. At Seawings Publications, we create visually stunning covers and illustrations that align perfectly with your genre, tone, and message.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            Our designers blend creativity with market awareness, ensuring your book stands out while maintaining professional appeal. From concept sketches to final production, every design is crafted to resonate with your audience and tell your story visually before the first page is turned.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            For children’s books, we bring characters and scenes to life with imaginative, emotion-filled illustrations. For fiction and non-fiction, we focus on color psychology, typography, and layout precision that elevate your presentation. With Seawings, your book doesn’t just look beautiful, it feels unforgettable.
          </motion.p>
            ...
            >
              ...
              {Chooseus.map((Chooseus, index) => (
                <div className="relative w-[350px] md:w-[300px] rounded-[32px] bg-white px-6 pt-12 pb-4 shadow-xl flex flex-col justify-center items-center md:items-start">
                  ...
                  <h2 className="absolute top-2 right-2 gradient-text text-[48px] text-white font-medium opacity-25">
                    {Chooseus.number}
                  </h2>
