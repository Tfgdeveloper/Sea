...
const Chooseus = [
  {
    number:"01",
    title: "Idea & Story Development",
    text: "We refine your concept, outline your vision, and structure your story into a compelling manuscript roadmap.",
    
  },
  {
    number:"02",
    title: "Research & Content Creation",
    text: "Our ghostwriters craft engaging, authentic content tailored to your voice, genre, and target audience.",
  },
  {
    number:"03",
    title: "Chapter Writing & Collaboration",
    text: "Each chapter is professionally written and shared with you for feedback, revisions, and creative alignment.",
  },
  {
    number:"04",
    title: "Final Manuscript Delivery",
    text: "Your completed manuscript is polished, professionally formatted, and prepared for publishing or submission.",  
  },
...
export default function Ghostwriting() {
  ...
  <div>
    <SEO
        title="Ghostwriting & Manuscript Services | Seawings Publications" 
        description="Professional ghostwriting and manuscript services to turn your ideas into polished, publish-ready books with expert writing and editing support."
        keyword="ghostwriting and manuscript services"
        link="https://www.seawingspublications.com/ghostwriting-&-manuscript"
...
Development Service
          ...
          >
            Turn your ideas into words that soar. At Seawings Publications, our ghostwriting experts help you craft captivating manuscripts that reflect your voice and vision, from the first concept to the final page.
          </motion.p>
            {/* Animated List Items */}
    ...
    <section className="relative w-full bg-white overflow-hidden z-0">
      ...
      <div className="max-w-[1600px] mx-auto flex flex-col md:flex-row gap-16 items-center justify-between px-4 md:px-8 py-16 relative">
        ...
        >
          ...
          >
            Crafting Words That Give Wings to Your Vision
          </motion.h2>
          ...
          >
            Every great book begins with an idea, and we’re here to bring that idea to life. Whether you have a rough outline, a collection of notes, or a story waiting to be told, our ghostwriting team transforms your vision into a complete, publish-ready manuscript.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            We collaborate closely with each author to preserve authenticity, tone, and purpose. Every line is written to match your tone, clear, engaging, and accurate to your story. From memoirs and novels to business guides and educational books, Seawings Publications tailors each manuscript to fit its intended audience.
          </motion.p>
          <motion.p 
            variants={itemVariants}
            className="text-center md:text-left mt-2 max-w-2xl text-black/80 text-[18px]"
          >
            Our process includes structured drafting, revisions, and professional feedback to ensure that your final work meets industry standards while staying faithful to your message. With Seawings by your side, your words will find their rhythm, and your story will finally take flight.
          </motion.p>
